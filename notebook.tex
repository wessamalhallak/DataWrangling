...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}76}]:} \PY{n}{df\PYZus{}csv}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
{\color{outcolor}Out[{\color{outcolor}30}]:} array([[<matplotlib.axes.\_subplots.AxesSubplot object at 0x0000024352C618D0>,
                ...
                [<matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243541E6F28>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243542185F8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x000002435423DC88>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x000002435426F358>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243542979E8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243542C70B8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243542EE748>],
                [<matplotlib.axes.\_subplots.AxesSubplot object at 0x0000024354317DD8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x000002435434A4A8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x000002435436FB38>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243543A3208>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243543C8898>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243543F1F28>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243544225F8>],
                [<matplotlib.axes.\_subplots.AxesSubplot object at 0x0000024354448C88>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x0000024354479358>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243544A49E8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243544D40B8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243544FA748>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x0000024354523DD8>,
                 <matplotlib.axes.\_subplots.AxesSubplot object at 0x00000243545544A8>]],
               dtype=object)
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}73}]:} \PY{n}{df}\PY{o}{=}\PY{n}{merged\PYZus{}2}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}74}]:} \PY{n}{df}\PY{o}{.}\PY{n}{to\PYZus{}csv}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{twitter\PYZus{}archive\PYZus{}master.csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{index\PYZus{}label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tweetid}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
Using the factors ( Catagories ) Stage , and name
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}79}]:} \PY{n}{df}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{stage}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}105}]:} \PY{n}{df\PYZus{}p1} \PY{o}{=} \PY{n}{df}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{p1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{filter}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{l+m+mi}{25}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}106}]:} \PY{n}{df\PYZus{}p2} \PY{o}{=} \PY{n}{df}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{p2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{filter}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{l+m+mi}{25}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}107}]:} \PY{n}{df\PYZus{}p3} \PY{o}{=} \PY{n}{df}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{p3}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{filter}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{l+m+mi}{25}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}113}]:} \PY{n}{df}\PY{p}{[}\PY{n}{df}\PY{o}{.}\PY{n}{rating\PYZus{}numerator}\PY{o}{\PYZlt{}}\PY{l+m+mi}{15}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{retweet\PYZus{}count}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rating\PYZus{}numerator}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{kind}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{scatter}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
